# Here in this project we declare column 'id' as integer primary key & auto_increment as 1,2,3,4
# And columns name,course,fee we declare as varchar (see in screenshot)
